...
namespace Ptv.XServer.Controls.Routing
{
    ...
    public class Route
    {
        ...
        /// </summary>
        private Demo.XrouteService.XRouteWSClient xroute;
            ...
            lock (routeClientLock)
            {
                ...
                xroute.BegincalculateRoute(data?.RequestWaypoints, null, null,
                    new Demo.XrouteService.ResultListOptions { polygon = true }, new Demo.XrouteService.CallerContext
                    {
                        ...
                        new Demo.XrouteService.CallerContextProperty { key = "CoordFormat", value = "PTV_SMARTUNITS" },
                        new Demo.XrouteService.CallerContextProperty { key = "ResponseGeometry", value = "WKB" }
        ...
        public void RouteCalculated(IAsyncResult result)
        {
            layer.Map.Dispatcher.Invoke((Action)(() =>
            {
                ...
                catch (Exception e)
                {
                    ...
                    if (updateRef == 1)
                    {
                        Func<Demo.XrouteService.WaypointDesc, Point> WaypointToPoint = 
    ...
    public class RouteSnapshot
    {
        ...
        /// </summary>
        public Demo.XrouteService.RouteInfo Info { get; set; }
    ...
    public class RequestData
    {
        ...
        /// </summary>
        public Demo.XrouteService.WaypointDesc[] Waypoints { get; set; }

        /// <summary>
        /// Gets the way point descriptions for the route portion to be updated
        /// </summary>
        public Demo.XrouteService.WaypointDesc[] RequestWaypoints { get; set; }
