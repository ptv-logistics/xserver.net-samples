...
namespace Ptv.XServer.Demo.GeoRSS
{
    ...
    public class GeoRssDemo : WorldCanvas
    {
        ...
        #region constructor
        /// <summary> Initializes a new instance of the <see cref="GeoRssDemo"/> class. Reads the earthquakes from an
        /// xml file and shows them as pins on the map. </summary>
        /// <param name="mapView"> The map to be used in the GeoRssDemo class. </param>
        public GeoRssDemo(MapView mapView)
            : base(mapView)
        {
