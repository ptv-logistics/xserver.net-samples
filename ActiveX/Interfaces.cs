...
namespace Ptv.XServer.Controls
{
    ...
    {
        /// <summary> Fired when the user clicks on any user-defined shape. </summary>
        /// <param name="id">The ID of the clicked shape, as specified in the call 
        /// to the corresponding method of <see cref="IShapes"/> interface. </param>
        [DispId(1)]
        void OnShapeClicked(int id);
    }

    /// <summary> Groups the shape functionality in a single interface. </summary>
    [Guid("3CC9BD22-FA0F-4F93-87A2-E05BF67F3524")]
    [InterfaceType(ComInterfaceType.InterfaceIsIDispatch)]
    public interface IShapes
    {
        /// <summary> Returns the number of shapes currently defined. </summary>
        [DispId(1)]
        int Count { get; }

        /// <summary> Removes all shapes. </summary>
        [DispId(2)]
        void Clear();

        /// <summary> Adds a marker to the map. </summary>
        ...
        /// in which the shapes are defined through <see cref="IShapes"/>. At the time of writing, the color 
        ...
        /// <summary> Adds a line to the map. </summary>.
        /// <param name="id">Unique shape ID.</param>
        ...
        /// <summary> Removes a specific shape, specified by its ID. </summary>
        /// <param name="id"> The ID of the shape to be removed. </param>
        /// <returns> True if the corresponding shape existed and could be removed, false otherwise. </returns>
        [DispId(5)]
        bool Remove(int id);
    }

    /// <summary> This is the main interface of the ActiveX map control.  All functionality is accessed through this interfaces. </summary>
    [Guid("CFDB280A-8005-47AC-8229-0D988A35C36D")]
    [InterfaceType(ComInterfaceType.InterfaceIsIDispatch)]
    public interface IMapControl
    {
        /// <summary> Gets or sets the URLs of PTV's xMap Server. </summary>
        [DispId(1)]
        string XMapUrl { get; set; }

        /// <summary> Gets or sets the copyright string to be shown in the map. </summary>
        [DispId(2)]
        string XMapCopyright { get; set; }

        /// <summary> Sets the map's center and zoom level. </summary>
        ...
        /// <summary> Returns the interface used to access the shape API. </summary>
        [DispId(4)]
        IShapes Shapes { get; }
    }
}
