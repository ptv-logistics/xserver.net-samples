...
namespace ServerSideRendering
{
    ...
    public partial class Window1 : Window
    {
        ...
        private XMapMetaInfo GetMetaInfo()
        {
            ...
            meta.SetCredentials("EBB3ABF6-C1FD-4B01-9D69-349332944AD9", "9358789A-A8CF-4CA8-AC99-1C0C4AC07F1E"); // set the basic authentication properties, e.g. EBB3ABF6-C1FD-4B01-9D69-349332944AD9/token for xserver internet
